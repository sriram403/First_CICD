...
class ModelEvaluation:
    ...
    def get_best_model(self):
        try:
            ...
            if not os.path.exists(model_evaluation_file_path):
                write_yaml_file(dir=model_evaluation_file_path,
                                )
                return model
            model_eval_file_content = read_yaml_file(file_dir=model_evaluation_file_path)
    ...
    def update_evaluation_report(self, model_evaluation_artifact: ModelEvaluationArtifact):
        try:
            ...
            model_eval_content = read_yaml_file(file_dir=eval_file_path)
            ...
            write_yaml_file(dir=eval_file_path, data=model_eval_content)
    ...
    def initiate_model_evaluation(self) -> ModelEvaluationArtifact:
        try:
            ...
            schema_content = read_yaml_file(file_dir=schema_file_path)
